...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_if_statement = 20,              /* if_statement  */
...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "PLUS", "IF", "ELSE", "EQ", "SEMICOLON", "LPAREN", "RPAREN",
  "$accept", "program", "statement_list", "statement", "assignment",
  "expression", "term", "if_statement", "condition", YY_NULLPTR
};
...
{
      11,    17,     1,    10,    19,     8,     2,    20,    13,    14,
      19,    12,    23,     9,    22,    25,     0,    24,    21,     0,
       0,    26
};
...
{
       0,     3,     7,    14,    15,    16,    17,    20,     5,    11,
       0,    16,    10,     3,     4,    18,    19,    18,    21,     6,
       9,    12,    19,    18,    16,     8,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* assignment: IDENTIFIER ASSIGN expression  */
#line 36 "parser.y"
                                 { 
        sym[yyvsp[-2] - 'a'] = yyvsp[0];  // Store the result in the symbol table
    }
...
#line 42 "parser.y"
                         { 
        yyval = yyvsp[-2] + yyvsp[0];  // Addition
    }
...
#line 51 "parser.y"
               { 
        yyval = sym[yyvsp[0] - 'a'];  // Retrieve variable value from symbol table
    }
